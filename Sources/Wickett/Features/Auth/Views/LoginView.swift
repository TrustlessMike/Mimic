        ...
        VStack(spacing: 0) {
            ...
            VStack(spacing: 40) {
                ...
                VStack(spacing: 16) {
                    ...
                    Text("Pay anyone, anywhere, instantly")
                        .font(.body)
                ...
                VStack(alignment: .leading, spacing: 14) {
                    LoginFeatureRow(icon: "bolt.fill", text: "Instant transfers")
                    LoginFeatureRow(icon: "lock.shield.fill", text: "Secure & private")
                    LoginFeatureRow(icon: "dollarsign.arrow.circlepath", text: "No hidden fees")
                }
