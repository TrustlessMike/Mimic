          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                ...
                {notificationCount > 0 && (
                  <span className="absolute top-1 right-1 min-w-[18px] h-[18px] px-1 text-[10px] font-bold bg-accent-rose text-white rounded-full flex items-center justify-center">
              ...
              {/* Dropdown */}
              {showNotifications && (
                <div className="absolute right-0 mt-2 w-80 bg-dark-800 border border-dark-700 rounded-xl shadow-xl overflow-hidden" style={{ zIndex: 9999 }}>
                      ...
                      <>
                        ...
                        {requests.map((req) => (
                          <div
                            ...
                            className="px-4 py-3 hover:bg-dark-700/50 border-b border-dark-700/50 cursor-pointer"
                          >
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1 min-w-0">
                                <p className="text-sm text-white">Pending payment request</p>
                        ...
                        {failedTx.map((tx) => (
                          ...
                          >
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1 min-w-0">
                                <p className="text-sm text-white">Failed transaction</p>
                                <p className="text-xs text-dark-400 truncate">
            ...
            {/* Divider */}
            <div className="h-8 w-px bg-dark-700/50"></div>
